...
export default function About() {
  return (
    <section id="نبذة" className="section-padding bg-linen-100">
      <div className="container-page">
        <SectionHeading title="نبذة عني" />

        <div className="grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-stretch">
          <div className="rounded-3xl border border-linen-300 bg-white p-8 shadow-card sm:p-10">
            <p className="text-base leading-7 text-ash-600">
          ...
          <div className="flex flex-col justify-center gap-3 rounded-3xl bg-coal-800 p-8 text-center text-linen-100 shadow-soft sm:p-10">
            <span className="text-5xl font-bold text-saffron-300 sm:text-6xl">
              +10
            </span>
            <span className="text-lg font-bold">سنوات خبرة</span>
            <p className="mt-2 text-sm leading-7 text-linen-200/80">
