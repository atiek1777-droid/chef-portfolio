      ...
      <div className="container-page">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-stretch">
          <div className="rounded-2xl border border-warmgray-200 bg-white p-8 sm:p-10">
            <p className="text-base leading-7 text-warmgray-700">
            ...
            <p className="mt-5 text-base leading-7 text-warmgray-700">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col justify-center gap-3 rounded-2xl bg-gradient-to-br from-amber-500 to-yellow-500 p-8 text-center text-white shadow-soft sm:p-10">
              <span className="text-5xl font-bold text-cream sm:text-6xl">
                +10
              </span>
